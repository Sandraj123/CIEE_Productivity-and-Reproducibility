---
title           : "My preregistration for Productivity and Reproducibility in Ecology and Evolution"
shorttitle      : "My preregistration"
date            : "`r Sys.setlocale('LC_TIME', 'C'); format(Sys.time(), '%d\\\\. %B %Y')`"

author: 
  - name        : Sandra Jaskowiak
    affiliation : 1
...
Productivity and Reproducibility course "Mini-Project"
...
This OSF project is meant to hold and backup all components of my mini-project for the "Productivity and Reproducibilty" Living Data Project 2025 course.

This project will use data from the R package "lterdatasampler" to demonstrate my understanding of productivity and reproducibility methods learned in this course. Data used is ice freeze and thaw dates for Madison, Wisconsin Area lakes (1853 - 2019)
